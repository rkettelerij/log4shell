...
| Apache        | Hadoop | Unknown | Not vuln | Uses log4j 1.x. |[source](https://blogs.apache.org/security/entry/cve-2021-44228) |
...
| Apache        | Kafka | All versions | Not vuln | Uses log4j 1.x. Are [plans to migrate to log4j2](https://issues.apache.org/jira/plugins/servlet/mobile#issue/HADOOP-12956) but never performed |[source](https://lists.apache.org/thread/lgbtvvmy68p0059yoyn9qxzosdmx4jdv) |
